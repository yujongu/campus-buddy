...
import { Switch, Button, StyleSheet, Text, Pressable, TextInput, View, Modal} from "react-native";
...
export class PointsProgressBar extends React.Component {
	...
	return (
        ...
        <View style={[styles.row]}>
            ...
            <View style={[[StyleSheet.absoluteFill], {backgroundColor: "#FFC2B0", width: this.getWidth(this.state.schoolPoints)}]}/>
            </View>
            <Text style={[styles.categoryText]}>
        ...
        <View style={[styles.row]}>
            ...
            <View style={styles.progressBar}>
            <View style={[[StyleSheet.absoluteFill], {backgroundColor: "#00ACBE", width: this.getWidth(this.state.fitnessPoints)}]}/>
            </View>
            <Text style={[styles.categoryText]}>
